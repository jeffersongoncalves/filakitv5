...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filakit.icon_style' => 'object',
            'filakit.theme_mode' => 'object',
            'filakit.phosphoricon_enabled' => 'boolean',
            'filakit.public_panel_enabled' => 'boolean',
            'filakit.admin_panel_enabled' => 'boolean',
            'filakit.app_panel_enabled' => 'boolean',
            'filakit.favicon.enabled' => 'boolean',
            'filakit.favicon.manifest.name' => 'string',
            'filakit.favicon.logo' => 'string',
            'filakit.favicon.favicon' => 'string',
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','filakit.icon_style','filakit.theme_mode',
'filakit.phosphoricon_enabled','filakit.public_panel_enabled','filakit.admin_panel_enabled','filakit.app_panel_enabled','filakit.favicon.enabled',
'filakit.favicon.manifest.name','filakit.favicon.logo','filakit.favicon.favicon','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.links./home/jefferson/devilbox/data/www/filakit/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'hashing.argon.verify','hashing.rehash_on_login','debugbar.enabled','debugbar.hide_empty_tabs','debugbar.except',
...
'blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','blade-phosphor-icons.prefix','blade-phosphor-icons.fallback',
'blade-phosphor-icons.class','blade-phosphor-icons.attributes','filament.broadcasting','filament.default_filesystem_disk','filament.assets_path',
...
'filament.admin.pages.dashboard','filament.app.auth.login','filament.app.auth.password-reset.request','filament.app.auth.password-reset.reset','filament.app.auth.logout',
'filament.app.auth.profile','filament.app.auth.email-verification.prompt','filament.app.auth.email-verification.verify','filament.app.pages.dashboard','filament.public.auth.logout',
'filament.public.pages.dashboard','livewire.update','livewire.upload-file',
